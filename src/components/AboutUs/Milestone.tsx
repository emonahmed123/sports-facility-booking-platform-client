  ...
  return (
    <section className=" py-[60px] md:py-[90px] ">
      <div className="max-w-[1170px] mx-auto px-5 xl:px-0">
        <h1 className="text-center font-bold  text-[36px] leading-[46px]    md:text-[60px] md:ledaing-[70px]  mb-10 font-Poppis">
          Our <span className="text-[#3d85ff] ">Milestones</span>{" "}
        </h1>
