...
const Team = () => {
  ...
  const datas: data = [
    ...
    },
    {
      ...
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtlPCTomT7A1MOU7wcxWeGD6VdqoKNsIBpZg&s",
    },
    {
      id: 3,
      name: "William B.",
  ...
  return (
    <section className="py-[60px] md:py-[90px] ">
      <div className="max-w-[1170px] mx-auto px-5 xl:px-0 font-Poppis">
        <h1 className="text-center font-bold  text-[36px] leading-[46px]    md:text-[60px] md:ledaing-[70px] mb-14 ">
          Our <span className="text-[#3d85ff] ">Team</span>{" "}
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-[10px]  gap-y-[15px] place-items-center justify-items-center  ">
          {datas?.map((data) => (
            <div className="w-[370px] lg:w-[300px]  xl:w-[370px] relative px-2 py-2 bg-[#f5f8fc] rounded-[9px] border  border-[#D4D8DE] font-Poppis">
              <img
