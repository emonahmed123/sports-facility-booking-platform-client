...
const HowItWorks = () => {
  return (
    <section className="py-[60px] md:py-[90px]  bg-[#F8F8F8]">
      ...
      <div className="max-w-[1170px] mx-auto px-5 xl:px-0 overflow-x-hidden">
        <VerticalTimeline>
          <VerticalTimelineElement
          ...
          >
            ...
            <p className="text-right text-[16px] leading-[26px] font-normal">
              ...
              bookings. Whether it's a last-minute game or a planned event,
          ...
          >
            ...
            <p className=" text-[16px] leading-[26px] font-normal">
              ...
              experience without any hassle. Your perfect sports facility is
          ...
          >
            ...
            <p className=" text-[16px] leading-[26px] font-normal">
              Head to the facility, show your booking confirmation, and enjoy
              your game! Arrive with confidence knowing your spot is reserved.
              Experience top-notch facilities and make the most of your
              playtime.
            </p>
          </VerticalTimelineElement>
        </VerticalTimeline>
