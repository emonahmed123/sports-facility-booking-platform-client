  ...
  return (
    <section className="pb-[60px] md:pb-[80px]">
      ...
      <div className="font-Poppins pt-[60px] lg:pt-0 px-5 lg:px-0">
        <div className="flex justify-center items-center gap-x-[100px] flex-col lg:flex-row gap-y-[30px]">
          <div className="w-[100%] lg:w-[50%] lg:bg-[#ECECEC] lg:h-[100vh] flex justify-center items-center">
            <div>
          ...
          <div className="w-[100%] lg:w-[50%]">
            <div className="max-w-[485px] mx-auto">
              ...
              >
                ...
                <button className="px-8 py-[14px] bg-primary rounded-[8px] text-[#FFF] font-Poppins text-16px font-semibold">
                  Contact
                </button>
              </form>
            </div>
